...
export default function DemoHero() {
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-col w-full md:flex-row bg-white overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)]"
        style={{
          minHeight: "674px",
          borderRadius: "32px",
        }}
      >
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-between p-8 md:p-16 lg:p-20">
          <div className="space-y-10">
            ...
            >
              Optimize your Edtech <br className="hidden md:block" />
            ...
            <div className="max-w-[469px]">
              ...
              <ul className="space-y-4">
                {[
                  "Navigation of our Cohort Learning Ecosystem",
                  "Questions and Answers session with Us",
                  "Technical Discussion with Team",
                  "Improvisation for your current Platform",
                ].map((item, index) => (
                  <li
                    key={index}
        ...
        <div
          className="bg-[#0066FF] flex flex-col w-full md:w-1/2 p-6 md:p-10"
